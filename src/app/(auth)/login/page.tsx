        ...
        <div className="hidden md:block relative z-10 w-full max-w-md rounded-2xl border border-white/15 bg-white/10 p-8 text-white backdrop-blur-xl shadow-2xl transition-all hover:border-white/25">
          <div className="flex flex-col space-y-6">
            ...
            <p className="text-lg font-medium leading-relaxed tracking-wide text-white/95">
              &ldquo;NoSTDs provides an ultra-secure, completely private platform for diagnostic screening. Get tested with complete anonymity, certified clinics, and full confidence.&rdquo;
            </p>

            <div className="border-t border-white/10 pt-4">
              <p className="font-semibold text-white">Dr. Sarah Jenkins</p>
              <p className="text-xs text-white/60">Chief Medical Director, NoSTDs Network</p>
            </div>
          </div>
        </div>
        ...
        <div className="mx-auto mt-4 mb-6 md:my-auto w-full max-w-[400px]">
          ...
          <div className="mb-4 flex justify-center">
            <div className="relative flex size-10 items-center justify-center rounded-xl bg-primary/10 border border-primary/20 shadow-[0_8px_30px_rgb(0,0,0,0.04)]">
              ...
              <div className="absolute -right-0.5 -top-0.5 size-2 rounded-full bg-primary border border-background" />
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative flex items-center">
                ...
                <Input
                  ...
                  className="pl-10 h-11 border-border focus-visible:border-primary/50 focus-visible:ring-primary/20"
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative flex items-center">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 h-11 border-border focus-visible:border-primary/50 focus-visible:ring-primary/20"
                />
                <button
                  type="button"
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full h-11 bg-primary text-primary-foreground font-semibold hover:bg-primary/95 transition-all shadow-md active:scale-[0.98]"
            >
              {isLoading ? (
